        ...
        <Container maxWidth="sm" className={classes.container}>
            ...
            >
                ...
                <Grid container className={classes.wrapIcon}>
                    ...
                    <br />
                    <p>
                        Via MijnApp kun je gemakkelijk bijvoorbeeld een verhuizing doorgeven,
                         een huwelijk partnerschap aangaan, ondersteuning aanvragen en veel meer.
                        </p>
                </Grid>
                ...
                <Grid container>
                    <Button className={classes.buttonOrange} onClick={handleDashboard}>Volgende stap
